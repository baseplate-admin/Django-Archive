...
const MiddleColumn = () => {
    ...
    */
    ...
    const [socketObject, setSocketObject] = useState(Object)

    useEffect(()=>{
        const socket = new WebSocket('ws://localhost:8000/api/v1/front/')
        socket.onopen = () => {
                    ...
                    <article className="media">
                        <figure className="media-left">
                            <p className="image is-64x64">
                                <img alt="user" className="is-rounded" src="https://bulma.io/images/placeholders/128x128.png" />
                            </p>
                        </figure>
                        ...
                        <div className="media-right">
                            <div className="item" onMouseEnter={(event) => { handlePhoneIconMouseEnter(event) }} onMouseLeave={(event) => { handlePhoneIconMouseLeave(event) }}>
                                <Tooltip
                                    animateFill
                                    title="Call"
                                    position="bottom"
                            ...
                            <div className="item" onMouseEnter={(event) => { handleVideoIconMouseEnter(event) }} onMouseLeave={(event) => { handleVideoIconMouseLeave(event) }}>
                                <Tooltip
                                    animateFill
                                    title="Video Call"
                                    position="bottom"
            ...
            <div id="last">
                <div className="columns is-mobile is-vcentered">
                    ...
                    <div className="column input-column" >
                        <div className="control has-icons-right has-icons-left">
                            ...
                            <span className="is-small icon is-right"
                                onMouseEnter={(event) => { handleEmojiIconMouseEnter(event) }}
                                onMouseLeave={(event) => { handleEmojiIconMouseLeave(event) }}
                            >
                                <Tooltip
                                    animateFill
                                    title="Emoji"
                            ...
                            <span className='is-small icon is-left' onMouseEnter={(event) => { handleAddIconMouseEnter(event) }} onMouseLeave={(event) => { handleAddIconMouseLeave(event) }} >
                                <Tooltip
                                    animateFill
                                    title="Add Items"
                                    position="top"
                    ...
                    <div className="column is-narrow send-icon"
                        onMouseEnter={(event) => { handleSendIconMouseEnter(event) }}
                        onMouseLeave={(event) => { handleSendIconMouseLeave(event) }}
